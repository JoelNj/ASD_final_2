...
public class EmployeeController {
    ...
    public ResponseEntity<EmployeeResponseDto> addEmployee(@RequestBody EmployeeRequestDto request) {
        ...
        EmployeeResponseDto employeeResponseDto = employeeService.addEmployee(request).get();
    ...
    public ResponseEntity<EmployeeResponseDto> getEmployeeById(@PathVariable Long id) {
        ...
        EmployeeResponseDto employeeResponseDto = employeeService.getEmployeeById(id).get();
    ...
    public ResponseEntity<EmployeeResponseDto> partiallyUpdateEmployee(
        ...
        // Write your code here
        EmployeeResponseDto employeeResponseDto = employeeService.partiallyUpdateEmployee(id, request).get();
        return ResponseEntity.status(HttpStatus.OK).body(employeeResponseDto);
    }
}
